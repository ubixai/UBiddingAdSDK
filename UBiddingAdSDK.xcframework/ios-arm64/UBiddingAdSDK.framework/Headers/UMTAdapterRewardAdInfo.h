...
/// 验证失败的原因----string
extern NSString *const UMTAdapterRewardAdCustomDataReasonKey;

/// 无法完成验证的错误码----number
extern NSString *const UMTAdapterRewardAdCustomDataErrorCodeKey;

/// 无法完成验证的错误原因----string，包括网络错误、服务端无响应、服务端无法验证等
extern NSString *const UMTAdapterRewardAdCustomDataErrorMsgKey;

/// 奖励类型，0:基础奖励 1:进阶奖励-互动 2:进阶奖励-超过30s的视频播放完成----number
/// 目前支持返回该字段的adn：csj
/// @warning: UbiXM的S2S的验证暂不支持
extern NSString *const UMTAdapterRewardAdCustomDataRewardTypeKey;

/// 建议奖励百分比， 基础奖励为1，进阶奖励为0.0 ~ 1.0，开发者自行换算----number
/// 目前支持返回该字段的adn：csj
/// @warning: UbiXM的S2S的验证暂不支持
extern NSString *const UMTAdapterRewardAdCustomDataRewardProposeKey;


/// 激励视频奖励信息，适用于ADN的奖励验证和UbiXM的S2S奖励验证
@interface UMTAdapterRewardAdInfo : UMTInterfaceBaseObject
